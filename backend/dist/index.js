...
app.get("/balances/inr", (_req, res) => {
    res.status(200).json(INR_BALANCES);
});
app.get("/balances/stock", (_req, res) => {
...
app.get("/balances/stock/:userId", (req, res) => {
    const userId = req.params.userId;
...
app.post("/trade/mint", (req, res) => {
    ...
    try {
        ...
        const userBalance = (_a = INR_BALANCES[userId]) === null || _a === void 0 ? void 0 : _a.balance;
...
app.post('/order/sell', (req, res) => {
    ...
    try {
        ...
        const userPosition = (_a = STOCK_BALANCES[userId]) === null || _a === void 0 ? void 0 : _a[stockSymbol];
        if (!userPosition) {
